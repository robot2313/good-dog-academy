...
const styles = StyleSheet.create({
  ...
  actionCard: { gap: spacingTokens.lg, borderRadius: radiusTokens.hero, padding: spacingTokens.xl, backgroundColor: colorTokens.brand.forest },
  actionTopRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacingTokens.sm },
  actionKicker: { ...typographyTokens.label, color: '#E8A17F', letterSpacing: 1.4 },
  ...
  primaryButton: { flex: 1, minHeight: 54, alignItems: 'center', justifyContent: 'center', borderRadius: radiusTokens.lg, paddingHorizontal: spacingTokens.md, backgroundColor: colorTokens.brand.gold },
  primaryButtonText: { ...typographyTokens.body, color: colorTokens.text.inverse, fontWeight: '900', textAlign: 'center' },
  secondaryButton: { minHeight: 54, alignItems: 'center', justifyContent: 'center', borderRadius: radiusTokens.lg, paddingHorizontal: spacingTokens.md, borderWidth: 1, borderColor: 'rgba(255,255,255,0.45)' },
  secondaryButtonText: { ...typographyTokens.body, color: colorTokens.text.inverse, fontWeight: '800' },
  stopCard: { gap: spacingTokens.xs, borderRadius: radiusTokens.xl, padding: spacingTokens.lg, backgroundColor: colorTokens.status.warningSurface, borderWidth: 1, borderColor: colorTokens.status.warningText },
  stopTitle: { ...typographyTokens.cardTitle, color: colorTokens.status.warningText },
  outcomeCard: { gap: spacingTokens.sm, borderRadius: radiusTokens.xl, padding: spacingTokens.lg, backgroundColor: colorTokens.surface.primary, borderWidth: 1, borderColor: colorTokens.border.subtle },
  savedCard: { gap: spacingTokens.sm, borderRadius: radiusTokens.xl, padding: spacingTokens.lg, backgroundColor: colorTokens.status.successSurface, borderWidth: 2, borderColor: colorTokens.status.successText },
  savedTitle: { ...typographyTokens.sectionTitle, color: colorTokens.status.successText },
  savedButton: { minHeight: 50, alignItems: 'center', justifyContent: 'center', borderRadius: radiusTokens.pill, paddingHorizontal: spacingTokens.md, backgroundColor: colorTokens.brand.primary },
  ...
  outcomeButton: { minHeight: 50, alignItems: 'center', justifyContent: 'center', borderRadius: radiusTokens.pill, paddingHorizontal: spacingTokens.md, backgroundColor: colorTokens.surface.selected, borderWidth: 1, borderColor: colorTokens.brand.primary },
  outcomeButtonText: { ...typographyTokens.body, color: colorTokens.brand.primary, fontWeight: '900' },
  fullPlanButton: { minHeight: 50, alignItems: 'center', justifyContent: 'center', borderRadius: radiusTokens.pill, paddingHorizontal: spacingTokens.md, borderWidth: 1, borderColor: colorTokens.border.strong, backgroundColor: colorTokens.surface.primary },
  fullPlanButtonText: { ...typographyTokens.supporting, color: colorTokens.brand.primary, fontWeight: '900', textAlign: 'center' },
  safetyCard: { gap: spacingTokens.sm, borderRadius: radiusTokens.hero, padding: spacingTokens.xl, backgroundColor: colorTokens.status.errorSurface, borderWidth: 2, borderColor: colorTokens.status.errorText },
  ...
  safetyActionRow: { minHeight: 64, flexDirection: 'row', alignItems: 'flex-start', gap: spacingTokens.sm, borderRadius: radiusTokens.lg, padding: spacingTokens.md, backgroundColor: colorTokens.surface.primary, borderWidth: 1, borderColor: colorTokens.border.subtle },
  stepBadge: { width: 28, height: 28, alignItems: 'center', justifyContent: 'center', borderRadius: radiusTokens.pill, backgroundColor: colorTokens.status.errorText },
  ...
  progressCard: { gap: spacingTokens.xs, borderRadius: radiusTokens.xl, padding: spacingTokens.lg, backgroundColor: colorTokens.status.successSurface, borderWidth: 1, borderColor: colorTokens.status.successText },
