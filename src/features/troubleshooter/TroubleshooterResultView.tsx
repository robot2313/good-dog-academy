...
const styles = StyleSheet.create({
  ...
  defaultSection: {},
  highlightSection: { backgroundColor: colorTokens.surface.selected, borderColor: '#CFE2C8' },
  exerciseSection: { backgroundColor: colorTokens.status.infoSurface, borderColor: '#B9CDD4' },
  warningSection: { backgroundColor: '#FFF4DF', borderColor: '#ECD4A8' },
  ...
  safetyCard: { borderRadius: radiusTokens.xl, padding: spacingTokens.md, gap: spacingTokens.xs, backgroundColor: colorTokens.status.errorSurface, borderWidth: 1, borderColor: '#E2C3BB' },
  safetyTitle: { ...typographyTokens.sectionTitle, color: colorTokens.status.errorText },
  progressCard: { borderRadius: radiusTokens.xl, padding: spacingTokens.md, gap: spacingTokens.xxs, backgroundColor: colorTokens.status.successSurface, borderWidth: 1, borderColor: '#CFE2C8' },
  progressTitle: { ...typographyTokens.cardTitle, color: colorTokens.status.successText },
  outcomeList: { gap: spacingTokens.sm },
  outcomeButton: { minHeight: 48, justifyContent: 'center', paddingHorizontal: spacingTokens.md, paddingVertical: spacingTokens.sm, borderRadius: 9, backgroundColor: colorTokens.surface.primary, borderWidth: 1, borderColor: colorTokens.brand.primary },
