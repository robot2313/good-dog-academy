...
export function MainTabBar({ state, descriptors, navigation, insets }: BottomTabBarProps): React.JSX.Element {
  return (
    <View
      style={[
        referenceStyles.tabBar,
        {
      ...
      {state.routes.map((route, index) => {
        ...
        return (
          <Pressable
            ...
            onPress={onPress}
            style={({ pressed }) => [referenceStyles.tabButton, pressed && referenceStyles.pressed]}
          >
            <View style={referenceStyles.tabIcon}>
...
function isMainTabName(routeName: string): routeName is keyof MainTabParamList {
  return routeName === 'Today' || routeName === 'Plan' || routeName === 'Academy' || routeName === 'Progress' || routeName === 'Dog';
}
