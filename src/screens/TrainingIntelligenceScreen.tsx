    ...
    <AppScreen>
      ...
      {!loading && !error && intel ? <>
        <View style={referenceScreenStyles.cardSelected}>
          ...
          <AppButton title="Open Weekly Trainer Review" onPress={() => navigation.navigate('WeeklyTrainerReview')} />
          <AppButton variant="secondary" title="Open Adaptive 7-Day Program" onPress={() => navigation.navigate('AdaptiveProgram')} />
