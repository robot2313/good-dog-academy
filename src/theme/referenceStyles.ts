...
export const referenceStyles = StyleSheet.create({
  ...
  todayImage: { width: 92, alignSelf: 'stretch', overflow: 'hidden', backgroundColor: referencePalette.greenSoft },
  cardSideImageFill: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, width: '100%', height: '100%' },
  ...
  recommendationImage: { width: 78, alignSelf: 'stretch', overflow: 'hidden', backgroundColor: referencePalette.greenSoft },
  ...
  jumpBackImage: { width: 82, alignSelf: 'stretch', overflow: 'hidden', backgroundColor: referencePalette.greenSoft },
